        ...
        var e = {
                933: (e, t, n) => {
                    ...
                    function g(e) {
                        const t = { toString: m };
                        let n, i, r;
                        if (((e = e.replace(/\s/g, "")), (n = new RegExp(u, "gi")), (i = n.exec(e)), i && ((t.protocol = i[1].toLowerCase()), (e = e.substring(n.lastIndex))), (n = new RegExp("^(//[^/?#]+)", "gi")), (i = n.exec(e)), i)) {
                            ...
                            (this.postis = (function (e) {
                                var t,
                                    ...
                                    h = function (e) {
                                        ...
                                        if ((!s || e.origin === s) && t && t.postis && t.scope === n) {
                                            ...
                                            else (d[t.method] = d[t.method] || []), d[t.method].push(t.params);
                                        }
                                    };
                                ...
                                var p = {
                                        listen: function (e, t) {
                                            (o[e] = o[e] || []), o[e].push(t);
                                            var n = d[e];
                                            if (n) for (var i = o[e], r = 0; r < i.length; r++) for (var s = 0; s < n.length; s++) i[r].call(null, n[s]);
                                            delete d[e];
                                        },
                                        send: function (e) {
                                            var t = e.method;
                                            (l || e.method === u) && i && "function" == typeof i.postMessage ? i.postMessage(JSON.stringify({ postis: !0, scope: n, method: t, params: e.params }), "*") : a.push(e);
                                        },
                                        ready: function (e) {
                                            l
                                                ? e()
                                        ...
                                        destroy: function (e) {
                                            clearInterval(t), (l = !1), r && "function" == typeof r.removeEventListener && r.removeEventListener("message", h), e && e();
                                        },
                                    },
                                    g = +new Date() + Math.random() + "";
                                return (
                                    (t = setInterval(function () {
                                        p.send({ method: u, params: g });
                                    }, 50)),
                                    p.listen(u, function (e) {
                                        if (e === g) {
                                            clearInterval(t), (l = !0);
                                            for (var n = 0; n < a.length; n++) p.send(a[n]);
                                            a = [];
                                        } else p.send({ method: u, params: e });
                                    }),
                                    p
                                );
                            })({ ...f, ...e })),
                                (this._receiveCallback = () => {}),
                                this.postis.listen(v, (e) => this._receiveCallback(e));
                        }
                        dispose() {
                            this.postis.destroy();
                        }
                        send(e) {
                            this.postis.send({ method: v, params: e });
                        }
                            ...
                            if (e.type === b) {
                                ...
                                e.type === _
                                    ? this.emit("request", e.data, (t, n) => {
                                          this._backend.send({ type: b, error: n, id: e.id, result: t });
                                      })
                        ...
                        sendRequest(e) {
                            ...
                            return new Promise((n, i) => {
                                this._responseHandlers.set(t, (e) => {
                                    ...
                                    void 0 !== r ? n(r) : i(void 0 !== t ? t : new Error("Unexpected response format!"));
                                });
                                try {
                                    this._backend.send({ type: _, data: e, id: t });
                                } catch (e) {
                                    this._responseHandlers.delete(t), i(e);
                                }
                            });
                        }
                        setBackend(e) {
                        ...
                        L = (function (e, t = !1, n = "hash") {
                            ...
                            return (
                                s.forEach((e) => {
                                    const n = e.split("="),
                                        i = n[0];
                                    if (!i || i.split(".").some((e) => d.includes(e))) return;
                                    let s;
                                    try {
                                        if (((s = n[1]), !t)) {
                    ...
                    var k = n(294);
                    const C = n.n(k)().getLogger("modules/API/external/functions.js");
                    function x(e, t) {
                        return e.sendRequest({ type: "devices", name: "setDevice", device: t });
                    }
                    const S = ["css/all.css", "libs/alwaysontop.min.js"],
                        E = {
                        ...
                        O = { "_request-desktop-sources": "_requestDesktopSources" };
                    let j = 0;
                    function I(e, t) {
                    ...
                    class N extends r() {
                            ...
                            (this._parentNode = s),
                                (this._url = (function (e) {
                                    ...
                                    if (!n.host) {
                                        ...
                                        if (t) {
                                            const { host: e, hostname: r, pathname: s, port: o } = g(h(`org.jitsi.meet://${t}`));
                                    ...
                                    devices: v,
                                    userInfo: _,
                                    appData: { localStorageContent: C },
                                    release: L,
                                    url: `https://${e}/#jitsi_meet_external_api_id=${j}`,
                                })),
                                this._createIFrame(r, i, k),
                                (this._transport = new w({ backend: new y({ postisOptions: { allowedOrigin: new URL(this._url).origin, scope: `jitsi_meet_external_api_${j}`, window: this._frame.contentWindow } }) })),
                        ...
                        _createIFrame(e, t, n) {
                            const i = `jitsiConferenceFrame${j}`;
                            (this._frame = document.createElement("iframe")),
                                (this._frame.allow = ["autoplay", "camera", "clipboard-write", "compute-pressure", "display-capture", "hid", "microphone", "screen-wake-lock", "speaker-selection"].join("; ")),
                                (this._frame.name = i),
                                (this._frame.id = i),
                                this._setSize(e, t),
                                this._frame.setAttribute("allowFullScreen", "true"),
                                (this._frame.style.border = 0),
                                n && (this._frame.sandbox = n),
                        ...
                        _getAlwaysOnTopResources() {
                            ...
                            return S.map((e) => new URL(e, n).href);
                        }
                        ...
                        _setupListeners() {
                            this._transport.on("event", (e) => {
                                ...
                                switch (t) {
                                    case "ready":
                                        var r;
                                        null === (r = this._onload) || void 0 === r || r.call(this);
                                        break;
                                    case "video-conference-joined":
                                        if (void 0 !== this._tmpE2EEKey) {
                                            ...
                                            this.executeCommand("setMediaEncryptionKey", JSON.stringify({ exportedKey: e(this._tmpE2EEKey), index: 0 })), (this._tmpE2EEKey = void 0);
                                        }
                                        (this._myUserID = i), (this._participants[i] = { email: n.email, avatarURL: n.avatarURL }), (this._iAmvisitor = n.visitor);
                                    case "participant-joined":
                                        (this._participants[i] = this._participants[i] || {}), (this._participants[i].displayName = n.displayName), (this._participants[i].formattedDisplayName = n.formattedDisplayName), I(this, 1);
                                        break;
                                    case "participant-left":
                                        I(this, -1), delete this._participants[i];
                                        break;
                                    ...
                                    case "prejoin-screen-loaded":
                                        this._participants[i] = { displayName: n.displayName, formattedDisplayName: n.formattedDisplayName };
                                        break;
                                    case "on-prejoin-video-changed":
                                        (this._isPrejoinVideoVisible = n.isVisible), this.emit("prejoinVideoChanged");
                                        break;
                                    case "video-conference-left":
                                        I(this, -1), delete this._participants[this._myUserID];
                                        break;
                        ...
                        updateNumberOfParticipants(e) {
                            ...
                            const t = Object.keys(e).reduce((t, n) => {
                                var i;
                                return null !== (i = e[n]) && void 0 !== i && i.participants ? Object.keys(e[n].participants).length + t : t;
                            }, 0);
                        ...
                        getAvailableDevices() {
                            return (function (e) {
                                return e.sendRequest({ type: "devices", name: "getAvailableDevices" }).catch((e) => (C.error(e), {}));
                            })(this._transport);
                        }
                        ...
                        getCurrentDevices() {
                            return (function (e) {
                                return e.sendRequest({ type: "devices", name: "getCurrentDevices" }).catch((e) => (C.error(e), {}));
                            })(this._transport);
                        }
                        ...
                        isParticipantForceMuted(e, t) {
                            return this._transport.sendRequest({ name: "is-participant-force-muted", participantId: e, mediaType: t });
                        }
                        ...
                        _isNewElectronScreensharingSupported() {
                            return this._transport.sendRequest({ name: "_new_electron_screensharing_supported" });
                        }
                        pinParticipant(e, t) {
                        ...
                        async setMediaEncryptionKey(e) {
                            ...
                            if (t) {
                                ...
                                this.executeCommand("setMediaEncryptionKey", JSON.stringify({ exportedKey: Array.from(new Uint8Array(e)), index: n }));
                            } else this.executeCommand("setMediaEncryptionKey", JSON.stringify({ exportedKey: !1, index: n }));
                        }
                        setVirtualBackground(e, t) {
                            this.executeCommand("setVirtualBackground", e, t);
                        }
                    }
                },
                399: (e, t, n) => {
                    e.exports = n(933).default;
                },
                696: (e, t) => {
                    "use strict";
                ...
                586: (e, t) => {
                    ...
                    (t.parse = function (e) {
                        const i = "object" == typeof (arguments.length <= 1 ? void 0 : arguments[1]) && (arguments.length <= 1 ? void 0 : arguments[1]),
                            ...
                            s = ((arguments.length <= 1 ? 0 : arguments.length - 1) > 1 && (arguments.length <= 2 ? void 0 : arguments[2])) || i || {},
                            o = JSON.parse(e, r);
                ...
                325: (e, t, n) => {
                    ...
                    function r(e, t) {
                        (this.logStorage = e),
                            ...
                            Object.values(i.levels).forEach(
                                function (e) {
                                    this[e] = function () {
                    ...
                    (r.prototype.stringify = function (e) {
                        ...
                        (r.prototype._log = function () {
                            ...
                            if (t) {
                                ...
                                (n && n.text) === t ? (n.count += 1) : (this.queue.push({ text: t, timestamp: e, count: 1 }), (this.totalLen += t.length));
                            }
                ...
                964: (e) => {
                                        ...
                                        (function () {
                                            ...
                                            return (
                                                ...
                                                !i || i.length <= 4
                                                    ...
                                                    : ((e.methodName = i[1]), (e.fileLocation = i[2]), (e.line = i[3]), (e.column = i[4]), e)
                                            );
                                        })(),
                                    a = n.concat(e.transports),
                                    c = 0;
                                c < a.length;
                                c++
                            ) {
                    ...
                    (s.setGlobalOptions = function (e) {
                        ...
                        (e.exports = s),
                        (s.levels = { TRACE: "trace", DEBUG: "debug", INFO: "info", LOG: "log", WARN: "warn", ERROR: "error" });
                },
                294: (e, t, n) => {
                    var i = n(964),
                        r = n(325),
                ...
                550: (e) => {
                    ...
                    function d(e, t, n, i) {
                        ...
                        else if (("function" == typeof o ? (o = s[t] = i ? [n, o] : [o, n]) : i ? o.unshift(n) : o.push(n), (r = c(e)) > 0 && o.length > r && !o.warned)) {
                            o.warned = !0;
